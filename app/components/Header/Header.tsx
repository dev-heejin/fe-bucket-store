...
import {Search , ArrowBack, LocalMall} from "@mui/icons-material";

export default function Header() {
    return <header className='w-full flex flex-col z-999'>
        {/*웹 화면에서만 노출되는 검정색 배경*/}
        <div
        ...
        <div className='w-full p-[20px] flex justify-between items-center lg:mt-[80px] lg:p-[40px_20px]'>
            <div className='flex justify-start items-center gap-[12px]'>
                <ArrowBack className={'lg:!hidden'} sx={{color: 'gray', fontSize: 24}}/>
            ...
            <div className='flex gap-[16px] justify-end items-cente'>
                ...
                <LocalMall className={'lg:!hidden'} sx={{color: 'gray', fontSize: 24}}/>
            </div>
        </div>
    </header>
}